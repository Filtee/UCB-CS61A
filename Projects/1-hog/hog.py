...
def is_swap(player_score, opponent_score):
    ...
    if difference == opponent_score % 100 // 10:
        return True
    else:
        return False
    # END PROBLEM 4
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if not who:  # who == 0
            ...
            # if it has extra bonus
            if feral_hogs and abs(num_rolls0 - result0) == 2:
                score0 += 3

            # add to score
            result0 = take_turn(num_rolls0, score1, dice)
            score0 += result0
            ...
            # if it has extra bonus
            if feral_hogs and abs(num_rolls1 - result1) == 2:
                score1 += 3

            # add to score
            result1 = take_turn(num_rolls1, score0, dice)
            score1 += result1
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    cnt, best_roll_num = 1, 1
    while cnt != 10:
        if make_averaged(roll_dice)(cnt, dice) < make_averaged(roll_dice)(cnt + 1, dice):
            best_roll_num = cnt + 1
        cnt += 1
